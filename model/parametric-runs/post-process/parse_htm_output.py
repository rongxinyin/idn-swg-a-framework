...
# %%
# list of ac scenarios
ac_scenario_list = ['Bedroom_AC_Only', 'No_AC', 'FullHouse_AC']
# list of orientation
orientation_list = ['South', 'West']
# list of end use
...
for orientation in orientation_list:
    for ac_scenario in ac_scenario_list:
        for case_name in case_list:
            case_id+=1
            print('Start the processing of case id: {}'.format(case_id))
            with open("../output_files/{}/init_{}.htm".format(location, case_id), encoding="utf-8") as f:
                data = f.read()
                ...
                # results['ac_scenario'] = ac_scenario
...
with open('IDN_Res_{}_Summary.csv'.format(location), 'w', newline='')  as output_file:
