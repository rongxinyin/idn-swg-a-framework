...
for location in Jakarta Balikpapan Padang Waingapu
do
	# location="Padang"
	...
	# Declare an array with the specific file suffixes
	file_suffixes=(8 9 33 34 58 59 83 84 108 109 133 134 158 159 183 184)
	for i in "${file_suffixes[@]}"
	do
		FILE="$input_folder/init_$i.imf"
